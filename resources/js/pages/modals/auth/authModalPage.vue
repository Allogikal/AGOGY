    ...
    <transition name="modal">
        <div class="modal-mask w-screen h-screen">
            <div class="flex justify-center items-center">
                <div class="modal-container flex flex-col items-center bg-background-modal bg-cover bg-center bg-no-repeat w-[30%] h-[90%]">
                        ...
                        <form @submit.prevent="authUser" class="flex flex-col w-full gap-y-8 items-center">
                            <div class="flex flex-col w-[90%] mt-[20%]">
                                ...
                                <input id="email"
                                       ...
                                       class="h-6 border-l-2 border-b-2 outline-none tracking-widest font-light font-['Gilroy'] border-white text-md text-white bg-inherit pl-3 pb-2 outline-0"
                                       type="email"/>
                            </div>
                            ...
                            <button type="submit" class="button flex w-24 h-24 gap-x-2 justify-center items-center mt-5">
                                ...
                                <span class="text-white font-light font-['Gilroy'] text-md">Sign in</span>
                            </button>
                            <p class="text-white font-['Gilroy'] mt-10">Don't have an account, please <a @click="this.$store.state.showAuthModal=false; this.$store.state.showRegisterModal=true;" class="cursor-pointer text-red-700 border-b-[1px] pb-1">sign up</a></p>
                        </form>
                    </div>
                </div>
            </div>
