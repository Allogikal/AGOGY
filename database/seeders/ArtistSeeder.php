...
class ArtistSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::factory()->create([
            ...
            'image' => 'http://agogy.site/public/storage/users/avatars/Allogikal.jpg',
        ...
        User::factory()->create([
            ...
            'image' => 'http://agogy.site/public/storage/users/avatars/ROOT.jpg',
        ...
        User::factory()->create([
            ...
            'image' => 'http://agogy.site/public/storage/users/avatars/МИЧЕЛЗ.jpg',
            'description' => 'Начинающий исполнитель нового поколения',
            'is_candidate' => 0,
            'role_id' => 2,
        ]);
        ...
        User::factory()->create([
            ...
            'password' => Hash::make('artistartist'),
            'image' => 'http://agogy.site/public/storage/users/avatars/Zivert.jpg',
        ...
        User::factory()->create([
            ...
            'password' => Hash::make('artistartist'),
            'image' => 'http://agogy.site/public/storage/users/avatars/DJ_SMASH.jpg',
        ...
        User::factory()->create([
            ...
            'password' => Hash::make('artistartist'),
            'image' => 'http://agogy.site/public/storage/users/avatars/WYR_GEMI.jpg',
        ...
        User::factory()->create([
            ...
            'email' => 'maga@mail.ru',
            'password' => Hash::make('artistartist'),
            'image' => 'http://agogy.site/public/storage/users/avatars/MAGA.jpg',
        ...
        User::factory()->create([
            ...
            'password' => Hash::make('artistartist'),
            'image' => 'http://agogy.site/public/storage/users/avatars/JUNONA_BOYS.jpg',
        ...
        User::factory()->create([
            ...
            'password' => Hash::make('artistartist'),
            'image' => 'http://agogy.site/public/storage/users/avatars/WEEKND.jpg',
        ...
        User::factory()->create([
            ...
            'email' => 'king@mail.ru',
            'password' => Hash::make('artistartist'),
            'image' => 'http://agogy.site/public/storage/users/avatars/КОРОЛЬИШУТ.jpg',
        ...
        User::factory()->create([
            ...
            'email' => 'chris@mail.ru',
            'password' => Hash::make('artistartist'),
            'image' => 'http://agogy.site/public/storage/users/avatars/Chris_Isaak.jpg',
        ...
        // SEEDS FOR ARTIST AUTH!!! ID:15
        User::factory()->create([
            'name' => 'С.Лазарев',
            'email' => 'lazarev@mail.ru',
            'password' => Hash::make('artistartist'),
            'image' => 'http://agogy.site/public/storage/users/avatars/ЛАЗАРЕВ.jpg',
            'description' => 'Российский певец, актёр и телеведущий. Один из самых востребованных артистов России',
            'is_candidate' => 0,
            'role_id' => 2,
        ]);
